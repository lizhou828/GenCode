...
<head>
	...
	<script src="${ctx}/js/productDict/index.js?v=${resourceVersion}"></script>
	<script src="${ctx}/js/productDict/batch.js?v=${resourceVersion}"></script>
	<script src="${ctx}/js/common/filebox.js?v=${resourceVersion}"></script>
	<link rel="stylesheet" href="${ctx}/css/common/file-upload.css?v=${resourceVersion}">
</head>
	...
	<div id="toolbar" class="jhui-toolbar">
		<div class="easyui-panel jhui-toolbar-header">
			<div class="functions">
				...
				<a  onclick="$.dataGridOperation.toolEdit('编辑','edit',  900, 500)" data-options="group:'g1',plain:true,iconCls:'icon-edit'" href="javascript:void(0);" class="easyui-linkbutton">编辑</a>
				...
				<a onclick="openDialog('批量上传','batch',700,300,null,startUploadNormalFile);" id="batchUploadBtn" data-options="group:'g1',plain:true,iconCls:'icon-redo'" href="javascript:void(0);" class="easyui-linkbutton">上传</a>
		...
		<div class="easyui-panel" data-options="border:false" style="height:40px;">
			<form action="" id="searchForm">
				<table class="jhui-table">
					<tbody>
					<tr>
						<th style="width:60px;">批准文号</th>
						<td> <input type="text" name="approvalNumber" class="easyui-textbox" /></td>
		...
		<table id="dg" class="easyui-datagrid" style="height: 100%;"
			...
			<thead>
				<tr>
					...
					<th field="approvalNumber" formatter="formatAppNum">批准文号</th>
					<th field="productName">产品名称</th>
					<th field="name">商品名</th>
					<th field="dosageForm">剂型</th>
					<th field="spec">含量规格</th>
					<th field="manufacturer">生产企业</th>
