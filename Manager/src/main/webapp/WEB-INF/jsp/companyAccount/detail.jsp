...
<form id="frmInput">
	...
	<div class="easyui-tabs" data-options="fit:true,plain:true,border:false" style="height: 100%">
		<div title="企业基本信息">
			<table class="jhui-tableHighlight">
				<tr>
					<th>公司名称:</th>
		...
		<%--<div title="印章信息">
			<jsp:include page="../companySeal/ShowAccountIndex.jsp"/>
		</div>--%>
		<div title="档案信息">
         <table class="jhui-tableHighlight">
			 <tr>
				 <th>查看档案详情</th>
				 <td><a href="/archive/company-${obj.id}.html">档案详情</a></td>
			 </tr>
			<%-- <tr>
				 <th>商品档案</th>
				 <td><a href="/archive/company-${obj.id}.html">商品档案</a></td>
			 </tr>
			 <tr>
				 <th>人员档案</th>
				 <td><a href="/archive/company-${obj.id}.html">人员档案</a></td>
			 </tr>--%>
		 </table>
		</div>
	</div>
