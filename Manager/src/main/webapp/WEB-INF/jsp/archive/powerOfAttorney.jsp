...
<c:set var="ctx" value="${pageContext['request'].contextPath}"/>
            ...
            <table id="dg" style="height: 100%" hidden="hidden" class="easyui-datagrid"
                   ...
                   url="/archive/company/powerOfAttorney/search?companyId=${param.companyId}">
                <thead>
                <tr>
                    <th field="powerOfAttorneyName">名称</th>
                    <th field="expiredDate">有效期至</th>
                    <th data-options="field:'file',align:'center',formatter:formatColumnOfPA">操作</th>
                </tr>
                </thead>
            </table>
<script>
