...
<form id="frmInput" action="editSave" method="post">
	...
	<input type="hidden" name="bankPermit" value="${obj.bankPermit}"/>
	<input type="hidden" name="bankPermitSign" value="${obj.bankPermitSign}"/>
		...
		<div title="审核信息">
			<table class="jhui-tableHighlight">
				<tr>
					<th>审核结果:</th>
					<td>
						<input name="status" type="radio" class="easyui-validatebox" value="2" checked="checked" />审核通过
						<input name="status" type="radio" class="easyui-validatebox" value="3"/>审核不通过
					</td>
				</tr>
				<tr>
					<th>审核理由:</th>
