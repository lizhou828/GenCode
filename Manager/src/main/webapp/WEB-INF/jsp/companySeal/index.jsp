...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/companySeal/index.js?v=${resourceVersion}"></script>
</head>
        ...
        <div class="easyui-panel" data-options="border:false" style="height:65px">
        	<form action="" id="searchForm">
				<table class="jhui-table">
					...
					<tr>
						<th>印章名称</th>
						<td><input class="easyui-textbox" name="sealName" type="text"></input></td>
						<th>审核人</th>
						<td><input class="easyui-textbox" name="audi" type="text"></input></td>
						<th>状态</th>
						<td>
